...
map<anabin, syst> readSyst_all(const char* collSystem="", const char* poiname="NJpsi", const char* nameTag="16025", bool readEffSyst=false, bool readAccSyst=false, bool readSigSyst=true,const char* prependPath="", bool doPrintTex=false, const char* texName="Systematics/systs.tex");
void printTex(vector< map<anabin, syst> > theSysts, const char* texName="Systematics/systs.tex", anabin mask=anabin(0,0,0,0,0,0,0,0));
