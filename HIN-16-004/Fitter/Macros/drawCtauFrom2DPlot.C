...
void printCtauFrom2DParameters(RooWorkspace myws, TPad* Pad, bool isPbPb, string pdfName, bool isWeighted);
                        ...
                        ) 
{
  ...
  t->DrawLatex(0.21, 0.86-dy, Form("%.1f #leq zed^{#mu#mu} < %.1f",cut.dMuon.Zed.Min,cut.dMuon.Zed.Max)); dy+=0.045;
